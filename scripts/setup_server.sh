...
echo "  2. Run scripts/bootstrap_auth.py LOCALLY (not on this server) to generate"
echo "     google-auth-state.json, then copy it to $INSTALL_DIR/secrets/ on this server."
